	...
	<div class="wrap">
		...
		<div class="navbar navbar-inverse" >
			<div class="navbar-inner">
				...
				<a class="brand" href="display.php">SUMMARY</a>
	...
	<div >
        ...
        $records = $common->getAllRecords($connection);
				...
				<tr class="text-error">
					...
					<input type="submit" name="submitDeleteBtn" href="delete-script.php?recordId=<?php echo $recordId?> class="btn btn-danger" value="Cancel"></th>
				</tr>
				<?php 
					}
					else
